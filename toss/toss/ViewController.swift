...
class ViewController: UIViewController {
    ...
    // UIStackView 생성
    private let reviewExamStackView: UIStackView = {
    ...
    private func setupUI() {
        ...
        contentView.addSubview(reviewExamStackView)
        contentView.addSubview(feedbackStack)
        contentView.addSubview(buttonStackView)
        
        containerView.addSubview(reviewExamStackView)
        ...
        reviewExamStackView.snp.makeConstraints {
            $0.edges.equalToSuperview().inset(10)
        }
        
        feedbackStack.snp.makeConstraints{
            $0.leading.trailing.equalToSuperview().inset(20)
            $0.top.equalTo(reviewExamStackView.snp.bottom).offset(30)
        }
